...
public final class ItemBannerBinding implements ViewBinding {
  ...
  private ItemBannerBinding(@NonNull MaterialCardView rootView, @NonNull ImageView imgBanner) {
  ...
  public static ItemBannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBannerBinding((MaterialCardView) rootView, imgBanner);
    }
