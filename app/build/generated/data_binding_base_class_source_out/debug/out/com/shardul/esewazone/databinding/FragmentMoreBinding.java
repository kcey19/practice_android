...
public final class FragmentMoreBinding implements ViewBinding {
  ...
  private FragmentMoreBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialCardView cardLogout, @NonNull TextView tvMoreTitle) {
  ...
  public static FragmentMoreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvMoreTitle;
      TextView tvMoreTitle = ViewBindings.findChildViewById(rootView, id);
      if (tvMoreTitle == null) {
        break missingId;
      }

      return new FragmentMoreBinding((ConstraintLayout) rootView, cardLogout, tvMoreTitle);
    }
